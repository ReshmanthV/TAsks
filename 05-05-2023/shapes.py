...
if shape == 'c':
    ...
    trinagle = Triangle()
    trinagle.input_sides()
    print("Perimeter of Triangle : ", trinagle.find_area())
    print("Area of Triangle : ", trinagle.find_perimeter())
elif shape == 'r':
    rectangle = Rectangle()
    ...
    square = Square()
    square.input_sides()
    print("Perimeter of Square : ", square.find_area())
    print("Area of Square : ", square.find_perimeter())
